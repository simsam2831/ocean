 ...
 */
final class Version20210325165806 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE answer_proposition (id INT AUTO_INCREMENT NOT NULL, fish_id INT DEFAULT NULL, description_answer LONGTEXT NOT NULL, image_answer VARCHAR(255) NOT NULL, is_correct TINYINT(1) NOT NULL, fish_quantity INT NOT NULL, INDEX IDX_6C353708311A1E2 (fish_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE bot (id INT AUTO_INCREMENT NOT NULL, name_bot VARCHAR(64) NOT NULL, difficulty VARCHAR(64) NOT NULL, is_bot_controlled TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `event` (id INT AUTO_INCREMENT NOT NULL, board_id INT NOT NULL, name_event VARCHAR(64) NOT NULL, description_event LONGTEXT NOT NULL, location INT NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_3BAE0AA7E7EC5785 (board_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fish_event (id INT NOT NULL, fish_id INT NOT NULL, fish_quantity INT NOT NULL, INDEX IDX_5561F8D78311A1E2 (fish_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, board_id INT NOT NULL, mode VARCHAR(255) NOT NULL, nb_players INT NOT NULL, is_pending TINYINT(1) NOT NULL, global_turn INT NOT NULL, UNIQUE INDEX UNIQ_232B318CE7EC5785 (board_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE question_event (id INT NOT NULL, category VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE token (id INT AUTO_INCREMENT NOT NULL, event_id INT DEFAULT NULL, price_token INT NOT NULL, image_token VARCHAR(255) NOT NULL, color VARCHAR(64) DEFAULT NULL, family VARCHAR(64) NOT NULL, is_selected TINYINT(1) NOT NULL, INDEX IDX_5F37A13B71F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(64) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE answer_proposition_question_event DROP FOREIGN KEY FK_C51A0F54A14B30FB');
        ...
        $this->addSql('ALTER TABLE answer_proposition_question_event DROP FOREIGN KEY FK_C51A0F5412FF5887');
